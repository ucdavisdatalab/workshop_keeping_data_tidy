...
Lastly, [as mentioned](#datalifecycle), it is important to describe and document all the decisions you make with your dataset. This data about your data is called **metadata**. Metadata has multiple levels, ranging from codebooks that explain what abbreviations and variable names stand for within a dataset, to READMEs which explain all the versions and what is contained in all the different datasets within your project directory, as well as documentation that describes the source and history of data collection. These practices all will improve the transparency, accessibility and reproducibility of your data collection, analyses and project workflow overall. 

For more information about metadata and data documentation, we will be holding [another workshop in March on this topic](https://datalab.ucdavis.edu/eventscalendar/readme-write-me/). 
